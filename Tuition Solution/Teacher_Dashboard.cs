...
namespace Tuition_Solution
{
    public partial class Teacher_Dashboard : Form
    {
        ...
        public Teacher_Dashboard(string name, string phone, string unique_id)
        {
            this.name = name;
            this.phone = phone;
...
";
        ...
        private void update_bt_Click(object sender, EventArgs e)
        {
            ...
            string query = $"update teacher_profiles SET email_id = '{email}', address = '{address}', qualification = '{qualification_box_user.Text}' WHERE unique_id = '{unique_id}'";
...
where al.status = 'PENDING' and al.subject= '{searchbox.Text}'";
        ...
        private void load_data()
        {
            ...
            if (red.Read())
            {
                ...
                qualification_box_user.Text = red["qualification"].ToString();
